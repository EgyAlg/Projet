...
class ShootSearch(object):
    ...
    def __init__(self):
        ...
        team1.add("Salah",IntelligentStrategy())
        team1.add("Brahimi",IntelligentStrategy())
        team2 = SoccerTeam("test2")
        team2.add("Warda",MyDefenseStrategy())
    ...
    def begin_round(self,team1,team2,state):
        ...
        self.simu.state.states[(1,0)].position = Vector2D(0,75)
        self.simu.state.states[(1,1)].position =Vector2D(0,20)
        self.simu.state.states[(1,0)].vitesse = Vector2D()
        self.simu.state.ball.position = Vector2D(20,45)
